...
func (r *dbRepository) GetById(id string) (*access_token.AccessToken, *errors.RestErr) {
	...
	if err := cassandra.GetSession().Query(queryGetAccessToken, id).Scan(&result.AccessToken, &result.UserId,
...
func (r *dbRepository) Create(at access_token.AccessToken) *errors.RestErr {
	...
	if err := cassandra.GetSession().Query(queryInsertAccessToken, at.AccessToken, at.UserId,
